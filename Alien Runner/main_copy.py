    ...
    if obstacle_list:
        for obstacle_box in obstacle_list:
            ...
            if obstacle_box.bottom == 300:
                display.blit(enemy_1, obstacle_box)
            else:
                display.blit(enemy_2, obstacle_box)

        obstacle_list = [obstacle for obstacle in obstacle_list if obstacle_box.left > -100]
...
while start:
    ...
    if game_state:
        ...
        obstacle_box_list = obstacle_movement(obstacle_box_list)
        ...
        if final_score == 0:
            ...
            display.blit(game_over_message, (290, 280))
